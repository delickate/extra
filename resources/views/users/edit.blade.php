...
<section class="counts-container mb-3">
    ...
    <div class="row mb-3">
        <div class="col-lg-10 col-md-10 pagetitle ps-lg-0">
          <h1 class="page_heading">Edit User </h1>
...
<!--                             <div class="col-md-3 form-group">
                        ...
                        <select disabled  class="form-control" id="province" name="province_id">
                            ...
                            @if(isset($user->district->district_name))
                            <div class="col-md-3 form-group">
                                <label for="">District</label>

                                <input disabled type="text" name="district" value="{{ old('district', $user->district->district_name) }}" class="form-control" required>
                            </div>
                            @endif
                            <div class="col-md-3 form-group">
                                ...
                                <div class="col-md-3 form-group mb-md-0">
                                    ...
                                    <ul class="list-unstyled">
                                        @foreach($roles as $r)
                                            @if($r->id != 1)
                                        <li class="list-item">
                                            <input name="roles" value="{{ $r->id }}" type="radio" @if( in_array($r->id, $userRole) ) checked @endif
                                            > &nbsp; {{ $r->name }}
                                        </li>
                                            @endif
                                        @endforeach
